...
class MyCur extends React.Component {
    ...
    fetchCryptocurrencyData() {
        this.channel.push("getUserCoins",{user_id: userId}).receive("ok", (resp) => {
            this.currency_list = resp.currency_list;
        });
        console.log(this.currency_list)
        this.channel.push("getAllCoins",{})
        .receive("ok", (response)  => {
            var wanted = ["bitcoin", "ethereum", "litecoin", "ripple", "stellar", "eos", "cardano", "iota", "neo", "dash", "tron", "tether", "vechain", "omisego", "qtum", "binance-coin"];
            var result = response.result.filter(currency => wanted.includes(currency.id));
                ...
                <div className="card bg-info">
                    <div className="text-center">
                        <div className="card-body">
                            ...
                            <strong> <p className="card-text text-danger">USD: {coin.price_usd}$ </p> </strong>
                            <a href={path} className="btn btn-primary">Know More!</a>
                        </div>
                    </div>
                </div>
            )
